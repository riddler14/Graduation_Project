<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Admin User Management.aspx.cs" Inherits="TenderManagementSystem.Admin_User_Management" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <asp:Button ID="Button2" class="btn btn-danger col-md-12" runat="server" Text="Delete User Permanently" OnClick="Button2_Click" />
                     </div>
                  </div>
               </div>
            </div>
            <a href="Admin Page.aspx"><< Back to Home</a><br>
            <br>
         </div>
          <div class="col-md-6">
            <div class="card">
          ...
          <div class="row">
              <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TenderManagementSystemConnectionString %>" SelectCommand="SELECT * FROM [Users]"></asp:SqlDataSource>
                     ...
                     <div class="col">
                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="member_id" DataSourceID="SqlDataSource1">
                            <Columns>
                                ...
                                <asp:BoundField DataField="member_id" HeaderText="User ID" SortExpression="member_id" ReadOnly="True" />
                            </Columns>
                         </asp:GridView>
                     </div>
                  </div>
