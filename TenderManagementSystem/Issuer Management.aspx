<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Issuer Management.aspx.cs" Inherits="TenderManagementSystem.Issuer_Management" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <asp:Button ID="Button2" class="btn btn-danger col-md-12" runat="server" Text="Delete Issuer Permanently" OnClick="Button2_Click" />
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="row">
             <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TenderManagementSystemConnectionString2 %>" SelectCommand="SELECT * FROM [Issuers]"></asp:SqlDataSource>
                     <div class="col">
                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="member_id" DataSourceID="SqlDataSource1">
                           <Columns>
                              ...
                              <asp:BoundField DataField="member_id" HeaderText="Issuer ID" SortExpression="member_id" ReadOnly="True" />
                           </Columns>
                        </asp:GridView>
                     </div>
                     </div>
